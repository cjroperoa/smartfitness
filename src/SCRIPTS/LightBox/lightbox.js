...
Lightbox.prototype = {
	...
	initialize: function() {	
		...
		//			<div id="closeText">
		//				<img src='../../IMAGENES/closed.gif' width='12' height='12' title='Close'/>
		//			</div>
		...
		closeIcon.setAttribute('src','../../IMAGENES/closed.gif');
		...
		objBottomNavCloseImage.setAttribute('src','../../IMAGENES/closed.gif');

...
<title>Eliminar Cliente - Administrador</title>	
...
?>
	<div id="contenedor"> 	
            <div id="opcverificar">
            <p>Realmente desea Eliminar Un Cliente</p>
            <a class="aceptar" href="ELIMINAR_CLIENTE.php" rel="lightbox_text" ><img src="../../IMAGENES/aceptar.png"/></a>

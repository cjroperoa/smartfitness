...
<title>Informe Cliente - Administrador</title>	
...
?>
	<div id="contenedor"> 	
            <div id="opcverificar">
            <p>Realmente desea Ver Informe de un Cliente</p>
            <a class="aceptar" href="MOSTRAR_INFORME_CLIENTE.php" rel="lightbox_text" ><img src="../../IMAGENES/aceptar.png"/></a>

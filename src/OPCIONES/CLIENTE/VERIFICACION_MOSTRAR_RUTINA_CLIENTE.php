...
<title>Rutina Cliente - Administrador</title>	
...
?>
	...
	<div id="contenedor"> 	
            <div id="opcverificar">
            <p>Realmente desea Ver Rutina de un Cliente</p>
            <a class="aceptar" href="MOSTRAR_RUTINA_CLIENTE.php" rel="lightbox_text" ><img src="../../IMAGENES/aceptar.png"/></a>

...
while ($row=mysql_fetch_array($result))
{
		...
		<legend> ACTUALIZAR DATOS </legend>
			...
			<input name="nombre" type="text" value="'.$row["nombre"].'" pattern="|^[a-zA-Z ñÑáéíóúüç]*$|" size="29" title="El nombre debe estar formado únicamente por letras"/>
			</div>
			...
			<input type="text" name="login" value="'.$row["login"].'" pattern="|^[a-zA-Z ñÑáéíóúüç]*$|" title="El usuario debe tner letras" size="29"/>
			</div>

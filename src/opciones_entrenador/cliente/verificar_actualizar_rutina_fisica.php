...
<title>Verificacion Actualizar Rutina Fisica</title>	
...
?>
	<div id="contenedor"> 	
            <div id="opcverificar">
            <p>Desea Actualizar Rutina Fisica</p>
            <a class="aceptar" href="actualizar_rutina_Fisica.php" rel="lightbox_text" ><img src="../../IMAGENES/aceptar.png"/></a>

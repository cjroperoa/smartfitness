...
<title>Verificacion Actualizar Informe</title>	
...
?>
	<div id="contenedor"> 	
            <div id="opcverificar">
            <p>Desea Actualizar Informe</p>
            <a class="aceptar" href="actualizar_informe_cliente.php" rel="lightbox_text" ><img src="../../IMAGENES/aceptar.png"/></a>

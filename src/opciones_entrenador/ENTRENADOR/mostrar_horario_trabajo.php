...
<title>Horario Entrenador</title>	
...
$mostrar_datos="select  horario from entrenador where documento='$variable_en';";
$enviar_consulta_mostrar=@mysql_query($mostrar_datos, $conexion);

echo '
<fieldset id="actualizardatos">
<legend><center>HORARIO DE ENTRENADOR</legend></center><br>
<table>
<tr>

...
<body>
    ...
    <div id="tbmenu">	 
		...
		<div id="menu">
		 <ul class="menu">
            ...
            <li><a href="como_acceder.php"><span>COMO ACCEDER</span></a></li>
	...
	<form>
	<legend>!No Puedes Acceder¡</legend>
    <label>Para tener acceso a nuestro sistema de información debes pertenecer al Gimnasio. De lo contrarito no podrás adquirir nuestra información personalizada.</label>
	<br />
	<br />

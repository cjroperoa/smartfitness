...
<body onload="MM_preloadImages('../../IMAGENES/imagenes/4.jpg')">
	<!-- Imagen Fondo CSS-->
    ...
    <label>Nuestros administradores son personas capacitadas totalmente para dirigir y acompañar el proceso físico durante la estadía en el Gimnasio. Son personas con gran calidad humana y responsabilidad total por su trabajo.</label>
	<br />
	<br />
	<center>
	  <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','../../IMAGENES/imagenes/4.jpg',1)"><img src="../../IMAGENES/imagenes/2.jpg" name="Image3" width="280" height="210" border="0" id="Image3" /></a>
	</center>
	</form>
    </fieldset>
	</div>

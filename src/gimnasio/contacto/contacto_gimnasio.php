...
<body>
    ...
    <div id="tbmenu">	 
		...
		<div id="menu">
		 <ul class="menu">
			...
			<li><a href="contacto_gimnasio.php"><span>CONTACTENOS</span></a></li> 
    ...
    <label>Teléfono: xxxxxxxx</label><br />
	<label>Ciudad: xxxxxxxx</label><br />
	<label>Dirección: xxxxxxxx</label><br />
	<label>Correo Electrónico: xxxxxxxx</label>
<br />
	<br />

...
<body>
	...
	<form>
	<legend>Historia Ruffer</legend>
    <label>Nuestro gimnasio fue creado en el año 2000 donde se abrieron las puertas a personas con autoestima baja por su estado físico y apariencia personal. Desde entonces el centro de acondicionamiento físico Ruffer se encarga de brindar acompañamiento continuo a los clientes, una asesoría total.</label>
	<br />
	<br />

...
<body>
	...
	<form>
	<legend>Misiòn</legend>
    <label>Somos un Gimnasio que brinda a nuestros clientes la comodidad, confiabilidad y acompañamiento para realizar sus procesos físicos dentro del gimnasio, permitiendo a nuestros clientes confianza para ejecutar su proceso. Manejamos las mejores maquinas y nuestro personal se encuentra totalmente capacitado para ejecutar sus acciones.</label>
	
	<br />
	<br />
	<marquee width=1020 direction=right>
